...
Description:
Shows a WebView2 for editing and displaying keynotes in the current Revit document.
__________________________________________________________________
How-To:
- Click the button to open the keynote manager window. If the window is already open, it will be focused instead of opening a new one.
__________________________________________________________________
Last update:
- [05.19.2025] - v0.1 Beta Release
__________________________________________________________________
